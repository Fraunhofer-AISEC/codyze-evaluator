 ...
 *
 * It connects the [DiskEncryption] key to the [Secret] created by the [CinderKeyManagerSecretPass]
 */
@ExecuteLate
@DependsOn(CinderKeyManagerSecretPass::class)
class CinderDiskEncryptionPass(ctx: TranslationContext) : ComponentPass(ctx) {
