 ...
 */
package de.fraunhofer.aisec.codyze.passes.concepts.config.openstack
    ...
    fun testConfigAndLoadingMinimal() {
        ...
        val result =
            analyze(listOf(), topLevel, true) {
                ...
                it.topLevels(
                    mapOf(
                        Castellan.name to topLevel.resolve("castellan").toFile(),
    ...
    fun testSecureCommunication() {
        ...
        val request =
            result.allExtended<HttpRequest> {
                QueryTree(it.concept.isTLS, operator = QueryOperators.EVALUATE) eq true
            }
