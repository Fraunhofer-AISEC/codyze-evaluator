 ...
 */
package de.bund.bsi.catalogue.logging
...
// by making an "abstract" query to be completed by the definition of a TOE-specific lambda
// expression
abstract class LogQueries {
    ...
    fun query_LogObjectsContainSpecifiedInformation(tr: TranslationResult): QueryTree<Boolean> {
        ...
        var logObject:
            LogObject // extract the LogObject from the nodes flowing out of a LogGenerator
        logObject = TODO()
    ...
    abstract fun toeSpecific_EventContainedInLogObject(
        event: LoggableEvent,
        logObject: LogObject,
    ): Boolean
}
