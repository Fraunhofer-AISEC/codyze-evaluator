    ...
    manualAssessment {
        of("Guideline-Known-Vulnerabilities") {
            ...
            */
            ...
            /**
            * A search for OpenStack vulnerabilities in the github.com/openstack/nova package results in various potential vulnerabilities. One listed vulnerability, for example, is CVE-2022-47951 which shows that the vulnerability has been fixed. Also, the vulnerability does not affect the 2024.2 release. One OSSA (2024-002 has been released which affects Nova in the 2024.2 release; a patch, however, has been released.
            */
        ...
        of("Continuous-Maintenance-Security-Policy") {
            ...
            */
            ...
            /**
            * The OpenStack projects have a common security policy defined, including information on vulnerability management
            */
            val actualValue = true
        ...
        of("Continuous-Testing-CI-Tests") {
            ...
            */
            ...
            /**
            * The individual checks for the opendev repository, repository template, zuul.yaml, zuul job definitions, check and gate pipelines, tox.ini file, the test directory, and gerrit 'verified' and 'workflow' parts were successful.
            */
            val actualValue = true
        ...
        of("Continuous-Testing-Fuzzing") {
            ...
            */
            ...
            /**
            * CI files (such as the Nova CI file) do not indicate a usage of fuzzing tools in the pipeline. Also, the security guide does not mention fuzzing tools.
            */
        ...
        of("CICD-Security-Gerrit-Settings") {
            ...
            */
            ...
            /**
            * Project is listed, config exists, access rights are correct, and review and workflow configs are proper.	
            */
            val actualValue = true
        ...
        of("CICD-Security-Branch-Protection") {
            ...
            */
            ...
            /**
            * Code must be approved by at least one core-reviewer and code must pass automated gate tests and automated testcases. These protections account to tier 4 (of 5) of OSSF criteria.	
            */
        ...
        of("Build-Risks-Signed-Releases") {
            ...
            */
            ...
            /**
            * Releases are signed but the signatures do not seem to be visible on the releases page.	
            */
            val actualValue = false
