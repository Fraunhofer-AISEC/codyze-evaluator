...
=== "Legacy"
    ...
    The legacy version of the OpenStack Checker requires a fixed project structure. It expects the following:
...
=== "Legacy"
    ...
    The legacy version of the OpenStack Checker requires the user to write down the security goals in a security goals yaml file.   
...
=== "Legacy"
    ...
    The legacy version of the OpenStack Checker requires the user to write the security statements in the `query.kts` files following a specific structure.
