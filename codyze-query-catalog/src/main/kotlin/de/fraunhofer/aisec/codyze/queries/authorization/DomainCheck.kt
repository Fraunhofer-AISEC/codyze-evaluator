 ...
 * [de.fraunhofer.aisec.cpg.graph.concepts.http.HttpEndpoint] [this].
 *
...
/**
 * Checks if an [de.fraunhofer.aisec.cpg.graph.concepts.http.HttpEndpoint] only throws "Not
 * Authorized" exceptions of a permitted class and none of the disallowed messages appear.
 */
...
/**
 * Checks if an [de.fraunhofer.aisec.cpg.graph.concepts.http.HttpEndpoint] only throws allowed
 * exceptions when domain checks fail.
 *
